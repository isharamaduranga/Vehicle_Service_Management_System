...
public class WaitingRepairFormController {

    public TableView tblWaitingRepairing;
    ...
    public void initialize(){
        ...
        new ZoomIn(tblWaitingRepairing).play();
    ...
    private void tableLoad() {
        try {
            ResultSet result = CrudUtil.execute
                    ("SELECT `sid`,`vnumber`,`model`,`modelname`,`nic`,`oname`,`stype`,`date` FROM add_to_service WHERE status=1 AND stype='Repairing'");
            ...
            tblWaitingRepairing.setItems(observableList);
            ...
            sortedData.comparatorProperty().bind(tblWaitingRepairing.comparatorProperty());
            tblWaitingRepairing.setItems(sortedData);
    ...
    public void tableDataPrintOnAction(ActionEvent actionEvent) {
        ...
        ReportsUtil.loadReport(tblWaitingRepairing,btnPrint,"waitingRepair");
